...
def openAI_from_Gemini(response,stream=True):
    ...
    # 安全的类型转换函数，处理 None、null 字符串和其他异常值
    ...
    usage_data = {
        "prompt_tokens": safe_int_convert(prompt_tokens_raw),
        "completion_tokens": safe_int_convert(candidates_tokens_raw),
        "total_tokens": safe_int_convert(total_tokens_raw)
    }
